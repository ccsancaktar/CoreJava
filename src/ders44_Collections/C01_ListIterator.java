...
public class C01_ListIterator {
    public static void main(String[] args) {
        /*
        Bir listedeki sayi araliginda olmayan elementleri
        silen bir program yaziniz. (2. liste olusturmadan, gecerli liste uzerinden)
        Örn; [2,13,56,23,45,14,40] istenen aralik 20 ile 40 arasi (sinirlar dahil)
        Output: [23,40]
         */
